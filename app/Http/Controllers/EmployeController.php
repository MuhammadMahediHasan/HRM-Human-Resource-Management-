...
class EmployeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            $employe_basic_info_id=$employe_basic_data->employe_basic_info_id;
            $employe_contact_data=new EmployeContactInfoModel;

            $employe_contact_data->employe_basic_info_id =$employe_basic_info_id;
            ...
            //Employee Bank Info
            $employe_bank_data=new EmployeBankInfoModel;
            $employe_bank_data->employe_basic_info_id =$employe_basic_info_id;
            ...
            $employe_joining_details_data=new EmployeJoiningDetailsModel;
            $employe_joining_details_data->employe_basic_info_id =$employe_basic_info_id;
            ...
            $employe_personal_bio_data=new EmployePersonalBioModel;
            $employe_personal_bio_data->employe_basic_info_id =$employe_basic_info_id;
    ...
    {
        $employe_data=EmployeModel::join('employe_contact_info','employe_contact_info.employe_basic_info_id','=','employe_basic_info.employe_basic_info_id')
                    ->join('employe_bank_info','employe_bank_info.employe_basic_info_id','=','employe_basic_info.employe_basic_info_id')
                    ->join('employe_joining_info','employe_joining_info.employe_basic_info_id','=','employe_basic_info.employe_basic_info_id')
                    ->join('employe_personal_bio','employe_personal_bio.employe_basic_info_id','=','employe_basic_info.employe_basic_info_id')
    ...
    public function destroy($id)
    {
        ...
        EmployeContactInfoModel::where('employe_basic_info_id',$id)->delete();
        EmployeBankInfoModel::where('employe_basic_info_id',$id)->delete();
        EmployeJoiningDetailsModel::where('employe_basic_info_id',$id)->delete();
        EmployePersonalBioModel::where('employe_basic_info_id',$id)->delete();
    ...
    {
        return EmployeModel::join('employe_contact_info','employe_contact_info.employe_basic_info_id','=','employe_basic_info.employe_basic_info_id')
                    ->join('employe_bank_info','employe_bank_info.employe_basic_info_id','=','employe_basic_info.employe_basic_info_id')
                    ->join('employe_joining_info','employe_joining_info.employe_basic_info_id','=','employe_basic_info.employe_basic_info_id')
                    ->join('employe_personal_bio','employe_personal_bio.employe_basic_info_id','=','employe_basic_info.employe_basic_info_id')
                    ->join('department','employe_basic_info.department_name','=','department.department_id')
                    ->join('branch','branch.branch_id','=','employe_basic_info.branch_name')
                    ->join('designation','designation.designation_id','=','employe_basic_info.designation_name')
                    ->where('employe_basic_info.employe_basic_info_id',$request->id)
                    ->first();
    }
