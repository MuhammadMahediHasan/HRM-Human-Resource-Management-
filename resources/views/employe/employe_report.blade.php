            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="/employe_report">Employee Report</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5>Search Employee with Department..</h5>
                                    <span>Table</span>
                                </div>
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <h4 class="text-center">Employe Report</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
