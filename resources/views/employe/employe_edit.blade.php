                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                {{Form::open(['url'=>"/add_employe/$employee->id",'method'=>'PUT','files'=>true])}} 
                                <div class="card-block row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label class="col-sm-12 col-form-label">Employee Name</label>
                                            <div class="col-sm-12">
                                                {{Form::text('employe_name',$employee->employe_name,['class'=>'form-control required','placeholder'=>'Employee Name'])}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                @php
                                                    $branch_array = [];
                                                    $branch_array[$employee->branch_id] = $employee->branch_name;
                                                @endphp
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                @php
                                                    $department_array = [];
                                                    $department_array[$employee->department_id] = $employee->department_name;
                                                @endphp
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <select id="designation_name" name="designation_name" class="form-control">
                                                    <option selected="selected" value="{{$employee->designation_id}}">{{ $employee->designation_name }}</option>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                {{Form::text('employe_code',$employee->employe_code,['class'=>'form-control required','placeholder'=>'Employee ID','readonly'])}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                {{Form::date('joining_date',$employee->joining_date,['class'=>'form-control required'])}}
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                {{Form::text('phone',$employee->phone,['class'=>'form-control required','placeholder'=>'Phone'])}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                {{Form::email('email',$employee->email,['class'=>'form-control required','placeholder'=>'Email'])}}
