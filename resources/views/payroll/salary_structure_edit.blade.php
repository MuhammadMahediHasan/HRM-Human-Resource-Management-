                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                {{Form::select('department_id',$department_array,'null',['class'=>'form-control','v-model'=>'formData.department_id'])}}
                                                <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                {{Form::select('designation_id',$designation_array,'null',['class'=>'form-control','v-model'=>'formData.designation_id','v-on:change'=>'GetEmployee'])}}
                                                <br>
    ...
    <script type="text/javascript">
        new Vue({
            ...
            data : {
                ...
                baseUrl : baseUrl,
                formData : {
                    branch_id : "{{$salary_structure_data->branch_id}}",
                    designation_id : "{{$salary_structure_data->designation_id}}",
                    department_id : "{{$salary_structure_data->department_id}}",
                },
                Employees : [],
            },
            methods:{
